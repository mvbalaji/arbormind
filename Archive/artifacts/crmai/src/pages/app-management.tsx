...
import {
  ...
  CheckCircle2, Lock, Layers, Zap, RefreshCw, Mic,
} from "lucide-react";
...
const MODULE_META: Record<string, {
  ...
  voice_commands: {
    ...
    screens: ["AI Assistant chatbot"],
    features: ["Speak queries via microphone", "AI replies read aloud (text-to-speech)", "Per-user speaker on/off toggle", "Works in Chrome & Edge"],
  },
};
