...
router.get("/search", async (req, res) => {
  ...
  try {
    const [canLeads, canOpps, canAccounts, canContacts, canCampaigns] = await Promise.all([
      userHasScreenAccess(u.role, "leads", "view"),
      userHasScreenAccess(u.role, "opportunities", "view"),
      userHasScreenAccess(u.role, "accounts", "view"),
      userHasScreenAccess(u.role, "contacts", "view"),
      userHasScreenAccess(u.role, "campaigns", "view"),
    ]);
