...
const QUOTES_COL_DEFAULTS: Record<typeof QUOTES_COL_KEYS[number], number> = {quoteNumber:100,name:320,revision:80,clonedFrom:140,validUntil:130,subtotal:110,total:120,createdBy:130,actions:60};

export default function Quotes() {
  const { widths: colWidths, startResize: startColResize } = useColResize("col-widths:quotes:v3", QUOTES_COL_KEYS, QUOTES_COL_DEFAULTS);
