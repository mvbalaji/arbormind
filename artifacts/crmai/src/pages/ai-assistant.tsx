        ...
        <div className="flex gap-4 border-b border-border pb-px">
          {["insights", "drafts", "scoring"].map(tab => (
            <button
              ...
              className={`px-3 py-1 font-medium text-sm capitalize transition-all border-b-2 ${activeTab === tab ? "border-sky-400 text-sky-400" : "border-transparent text-muted-foreground hover:text-foreground"}`}
            >
