      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl font-semibold text-sm transition-all hover:-translate-y-0.5 hover:shadow-lg"
            style={{
      ...
      <main className="relative z-10">
        ...
        <section className="px-6 md:px-12 pt-20 pb-24 text-center max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="/api/auth/google"
              className="flex items-center gap-3 px-7 py-3.5 rounded-2xl font-semibold text-base transition-all hover:-translate-y-1 hover:shadow-2xl"
              style={{
                background: "linear-gradient(135deg, #6366f1, #4f46e5)",
                color: "white",
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <a
                  href="/api/auth/google"
                  className="flex items-center gap-3 px-8 py-3.5 rounded-2xl font-semibold transition-all hover:-translate-y-1 hover:shadow-2xl"
                  style={{
                    background: "linear-gradient(135deg, #6366f1, #4f46e5)",
                    color: "white",
                    boxShadow: "0 8px 24px rgba(99,102,241,0.35)",
